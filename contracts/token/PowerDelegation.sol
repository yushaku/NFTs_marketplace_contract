...
import { IPowerDelegationMixin } from "../interfaces/IPowerDelegationMixin.sol";
 ...
 */
abstract contract PowerDelegationMixin is ERC20, IPowerDelegationMixin {
  ...
  function getPowerCurrent(
    ...
    (
      ...
      mapping(address => uint256) storage snapshotsCounts, // delegates
