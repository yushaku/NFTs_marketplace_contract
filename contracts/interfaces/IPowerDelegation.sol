...
import { DelegationType } from "./enum.sol";

interface IPowerDelegation {
  /**
  ...
  /**
   * @dev Returns the current delegated power of a user.
   * The current power is the power delegated at the time of the last snapshot.
   *
